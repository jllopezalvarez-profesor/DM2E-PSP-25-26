package es.jllopezalvarez.psp.ut02procesos.ejemplos.ejemplo07sincronizacion;
...
public class ChildProcess {
    ...
    private static final Path PATH_FICHERO_DATOS = Paths.get("./programs-output", "ejemplo-07.txt");
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        // Mientras exista el fichero, esperar
        while (lock.exists()) {
        ...
        // Crear el fichero una vez que se ha comprobado que no existe.
        lock.createNewFile();
