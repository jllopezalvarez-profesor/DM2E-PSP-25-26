package es.jllopezalvarez.psp.ut06seguridad.ejemplos;
...
public class Ejemplo01HashMessageDigest {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException {
        ...
        Faker faker = new Faker(Locale.forLanguageTag("es"), new Random(0));
        // Se puede hacer con otros juegos de caracteres
        ...
        for (int i = 0; i < 5; i++) {
            ...
            // Convertimos el digest a base64 para poder mostrarlo en pantalla
    ...
    private static byte[] calculaDigest(String mensaje) throws NoSuchAlgorithmException {
        ...
        // Calculamos el digest y devolvemos el resultado
        return digest.digest(bytesMensaje);
    }
